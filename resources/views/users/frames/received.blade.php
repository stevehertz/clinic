                ...
                <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="custom-tabs-four-home-tab"
                            ...
                            aria-selected="true">
                            @lang('labels.users.tabs.inventory.frames.received.hq')
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="custom-tabs-four-profile-tab"
                            ...
                            aria-selected="false">
                            @lang('labels.users.tabs.inventory.frames.received.clinics')
                        </a>
                    </li>
                </ul>
            </div>
                ...
                <div class="tab-content" id="custom-tabs-four-tabContent">
                    <div class="tab-pane fade show active" id="custom-tabs-four-home"
                        ...
                        <div class="table-responsive">
                            <table id="framesReceivedFromHQData"
                    ...
                    <div class="tab-pane fade" id="custom-tabs-four-profile"
                        ...
                        <div class="table-responsive">
                            <table id="framesReceivedFromClinicsData"
                                class="table table-bordered table-striped table-hover">
                                <thead>
                                    <tr>
                                        <th></th>
