                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select id="receiveFromHQTransferedStock" name="hq_frame_transfer_id" class="select2"
                                    data-placeholder="Select transfered stock you've received" style="width: 100%;">
                                    <option selected="selected" disabled="disabled">
                                        Select transfered stock you've received
                                    </option>
                                    @forelse ($clinic->hq_frame_transfer_to()->where('received_status', 0)->latest()->get() as $transfered_stock)
                                        <option value="{{ $transfered_stock->id  }}">
                                            Frame code: {{ $transfered_stock->frame_code }} - 
