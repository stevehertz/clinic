...
@section('content')
    ...
    <form id="forgotPasswordForm" method="post">
        ...
        <div class="row">
            <div class="col-12">
                <button type="submit" id="forgotPasswordSubmitBtn" class="btn btn-primary btn-block">Request new password</button>
            </div>
            <!-- /.col -->
        </div>
    </form>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#forgotPasswordForm').submit(function(e){
                ...
                var path = '{{ route('admin.forget.password') }}';
                $.ajax({
                    url:path,
                    type:'POST',
                    data:formData,
                    ...
                    processData:false,
                    beforeSend:function(){
                        $('#forgotPasswordSubmitBtn').html('<i class="fa fa-spinner fa-spin"></i>');
