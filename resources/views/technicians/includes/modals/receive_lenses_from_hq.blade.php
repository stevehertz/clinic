                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select id="receiveFromHQTransferedStock" name="hq_lens_transfer_id" class="select2"
                                    data-placeholder="Select transfered stock you've received" style="width: 100%;">
                                    <option selected="selected" disabled="disabled">
                                        Select transfered stock you've received
                                    </option>
                                    @forelse ($workshop->hq_lens_transfer_to()->where('received_status', 0)->latest()->get() as $transfered_stock)
                                        <option value="{{ $transfered_stock->id  }}">
                                            Lens code: {{ $transfered_stock->hq_lens->code }} - 
                                            Eye: {{ $transfered_stock->hq_lens->eye }} - 
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="receiveFromHQReceivedDate" name="received_date"
