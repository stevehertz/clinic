<div class="row">
    <div class="col-6">
        <button type="button"
            ...
            @lang('buttons.technicians.inventory.receive_hq')
        </button>
    </div>

    <div class="col-6">
        <button type="button" class="btn btn-block btn-outline-success">
            @lang('buttons.technicians.inventory.receive_clinic')
        </button>
    </div>
</div>
<!--/.row -->
                ...
                <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="custom-tabs-four-home-tab"
                            ...
                            aria-selected="true">
                            @lang('labels.technicians.tabs.inventory.cases.received.hq')
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="custom-tabs-four-profile-tab"
                            ...
                            aria-selected="false">
                            @lang('labels.technicians.tabs.inventory.cases.received.clinics')
                        </a>
                    </li>
                </ul>
            </div>
