...
@section('content')
    ...
    <form id="loginForm" method="post">
        ...
        <div class="row">
            ...
            <!-- /.col -->
            <div class="col-4">
                <button id="loginSubmitBtn" type="submit" class="btn btn-primary btn-block">
                    Sign In
                </button>
            </div>
            <!-- /.col -->
    ...
    <script>
        $(document).ready(function() {
            $('#loginForm').submit(function(e) {
                ...
                var path = '{{ route('technicians.login') }}';
                $.ajax({
                    url: path,
                    type: 'POST',
                    data: formData,
                    ...
                    success: function(data) {
                        if (data['status']) {
                            ...
                            setTimeout(function() {
                                window.location.href = '{{ route('technicians.dashboard.index') }}';
                            }, 2000);
                        }
                    },
                    error: function(data) {
