...
class ClinicOrdersReport implements FromView
{
    ...
    public function view(): View
    {
        ...
        if (!empty($this->from_date) && !empty($this->to_date)) {
            ...
            $data = $clinic->order()->join('order_tracks', 'orders.id', '=', 'order_tracks.order_id')
                ->select('orders.id', 'orders.patient_id', 'orders.clinic_id', 'orders.receipt_number', 'orders.lens_power_id', 'orders.lens_prescription_id', 'orders.frame_prescription_id', 'orders.closed_date', 'orders.workshop_id', 'order_tracks.track_status', 'order_tracks.track_date')
